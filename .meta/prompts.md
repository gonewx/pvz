...
- [] 植物和僵尸正下方要有阴影的效果
- [] 植物卡片选择时，鼠标点击时，如果当前卡片的阳光值不足，当前总阳光值需要有交互表现：阳光数字要红/黑闪烁
- [] 在教学关卡，提示选择植物卡片上要有闪烁效果，而且下方的闪烁的箭头要一直显示，直到选择，鼠标悬停时要切换为手形
- [] 教学关卡，提示种植植物时，草皮闪烁的效果是应用在渲染的整个草皮上，而不是网格
