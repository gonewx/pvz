...
- []  土豆地雷的动画要实现的是，当僵尸靠近时，距离越近，头顶的警告灯闪烁的频率越快。请分析实际的动画定义文件, 找到最优雅的实现方案.

  - anim_armed 土豆地雷有正确的效果,但是头顶的警告灯闪烁频率固定
  - anim_light 只是能控制头顶的警告灯是否显示
  - anim_glow 是显示静态的头顶的警告灯是红色的效果
