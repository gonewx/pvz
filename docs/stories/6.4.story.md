...
本 Story 的实现方案已被废弃，被 Story 6.6 的通用播放模式系统替代。
...
**替代方案**: 请参考 Story 6.6 (Reanim 播放模式通用化)

**废弃日期**: 2025-11-03 (Story 6.7 清理完成)

**代码清理**: Story 6.7 已删除所有相关代码（AnimLayer, PlayAnimationOverlay, HeadTracks, BaseAnimName, OverlayAnims）
---

## Status
Deprecated（已废弃 - 2025-11-03）
