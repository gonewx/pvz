...
| 音效文件 | 使用位置 | 说明 |
|----------|----------|------|
| `buttonclick.ogg` | `main_menu_buttons.go` | 按钮点击音 |
...
| `gravebusterchomp.ogg` | 墓碑吞噬者吃墓碑 | 高 | 10.10 |
...
| `splat.ogg` / `splat2.ogg` / `splat3.ogg` | 僵尸死亡/粉碎 | 高 | 10.9 |
...
| `tap.ogg` / `tap2.ogg` | 点击/轻触 | 中 | 已使用 |
| `pause.ogg` | 暂停音效 | 高 | 10.9 |
| `seedlift.ogg` | 种子槽上升 | 高 | 10.9 |
| `roll_in.ogg` | 种子槽滚入 | 高 | 10.9 |
...
| `throw.ogg` / `throw2.ogg` | 投掷音效 | 中 | 10.10 |
...
|----------|--------------|--------|-------|
| `rain.ogg` | 下雨场景 | 低 | - |
| `thunder.ogg` | 雷电效果 | 高 | 10.9 |
| `grassstep.ogg` | 草地脚步声 | 低 | - |
| `dirt_rise.ogg` | 泥土隆起(僵尸出土) | 高 | 10.9 |
...
| 13 | `seedlift.ogg` | 游戏开始种子槽升起 | 10.9 |
